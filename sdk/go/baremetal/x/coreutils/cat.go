...
func (o CatOutput) Connection() pulumix.GPtrOutput[config.ProvisionerConnection, config.ProvisionerConnectionOutput] {
	value := pulumix.Apply[Cat](o, func(v Cat) pulumix.GPtrOutput[config.ProvisionerConnection, config.ProvisionerConnectionOutput] {
		return v.Connection
	})
