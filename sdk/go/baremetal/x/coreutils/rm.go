...
func NewRm(ctx *pulumi.Context,
	...
	var resource Rm
	err := ctx.RegisterResource("baremetal:coreutils:Rm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRm(ctx *pulumi.Context,
	...
	var resource Rm
	err := ctx.ReadResource("baremetal:coreutils:Rm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o RmOutput) Connection() pulumix.GPtrOutput[baremetal.ProvisionerConnection, baremetal.ProvisionerConnectionOutput] {
	value := pulumix.Apply[Rm](o, func(v Rm) pulumix.GPtrOutput[baremetal.ProvisionerConnection, baremetal.ProvisionerConnectionOutput] {
		return v.Connection
	})
