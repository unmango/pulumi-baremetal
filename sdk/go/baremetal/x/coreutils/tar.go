...
func (o TarOutput) Connection() pulumix.GPtrOutput[config.ProvisionerConnection, config.ProvisionerConnectionOutput] {
	value := pulumix.Apply[Tar](o, func(v Tar) pulumix.GPtrOutput[config.ProvisionerConnection, config.ProvisionerConnectionOutput] {
		return v.Connection
	})
