...
func (o WgetOutput) Connection() baremetal.ProvisionerConnectionPtrOutput {
	return o.ApplyT(func(v *Wget) baremetal.ProvisionerConnectionPtrOutput { return v.Connection }).(baremetal.ProvisionerConnectionPtrOutput)
}
