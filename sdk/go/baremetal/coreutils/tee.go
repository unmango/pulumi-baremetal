...
func (o TeeOutput) Connection() baremetal.ProvisionerConnectionPtrOutput {
	return o.ApplyT(func(v *Tee) baremetal.ProvisionerConnectionPtrOutput { return v.Connection }).(baremetal.ProvisionerConnectionPtrOutput)
}
