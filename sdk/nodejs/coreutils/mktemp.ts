...
export class Mktemp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'baremetal:coreutils:Mktemp';
    ...
    public readonly args!: pulumi.Output<outputs.coreutils.MktempArgs>;
...
export interface MktempArgs {
    args: pulumi.Input<inputs.coreutils.MktempArgsArgs>;
