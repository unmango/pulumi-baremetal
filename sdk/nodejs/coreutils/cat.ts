...
export class Cat extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'baremetal:coreutils:Cat';
    ...
    public readonly args!: pulumi.Output<outputs.coreutils.CatArgs>;
...
export interface CatArgs {
    args: pulumi.Input<inputs.coreutils.CatArgsArgs>;
