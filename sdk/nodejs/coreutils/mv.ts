...
export class Mv extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'baremetal:coreutils:Mv';
    ...
    public readonly args!: pulumi.Output<outputs.coreutils.MvArgs>;
...
export interface MvArgs {
    args: pulumi.Input<inputs.coreutils.MvArgsArgs>;
