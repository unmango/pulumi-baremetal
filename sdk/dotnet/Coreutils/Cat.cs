...
{
    [BaremetalResourceType("baremetal:coreutils:Cat")]
    public partial class Cat : global::Pulumi.CustomResource
    {
        ...
        public Cat(string name, CatArgs args, CustomResourceOptions? options = null)
            : base("baremetal:coreutils:Cat", name, args ?? new CatArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cat(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("baremetal:coreutils:Cat", name, null, MakeResourceOptions(options, id))
        {
        }
