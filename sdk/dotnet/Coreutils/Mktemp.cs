...
{
    [BaremetalResourceType("baremetal:coreutils:Mktemp")]
    public partial class Mktemp : global::Pulumi.CustomResource
    {
        [Output("args")]
        public Output<Outputs.MktempArgs> Args { get; private set; } = null!;
        ...
        public Mktemp(string name, MktempArgs args, CustomResourceOptions? options = null)
            : base("baremetal:coreutils:Mktemp", name, args ?? new MktempArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Mktemp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("baremetal:coreutils:Mktemp", name, null, MakeResourceOptions(options, id))
        {
        }
