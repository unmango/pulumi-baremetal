...
namespace UnMango.Baremetal.Coreutils
{
    ...
    /// </summary>
    [BaremetalResourceType("baremetal:coreutils:Tee")]
    public partial class Tee : global::Pulumi.CustomResource
    {
        ...
        public Tee(string name, TeeArgs args, CustomResourceOptions? options = null)
            : base("baremetal:coreutils:Tee", name, args ?? new TeeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tee(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("baremetal:coreutils:Tee", name, null, MakeResourceOptions(options, id))
        {
        }
