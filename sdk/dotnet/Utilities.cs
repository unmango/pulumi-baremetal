...
namespace UnMango.Baremetal
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/unmango";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("UnMango.Baremetal.version.txt");
    ...
    internal sealed class BaremetalResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public BaremetalResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
