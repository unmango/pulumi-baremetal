...
__all__ = ['KubeadmArgs', 'Kubeadm']

@pulumi.input_type
class KubeadmArgs:
    def __init__(__self__, *,
                 args: pulumi.Input['KubeadmArgsArgs'],
    ...
    @property
    @pulumi.getter
    def args(self) -> pulumi.Input['KubeadmArgsArgs']:
        return pulumi.get(self, "args")

    @args.setter
    def args(self, value: pulumi.Input['KubeadmArgsArgs']):
...
class Kubeadm(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 args: Optional[pulumi.Input[Union['KubeadmArgsArgs', 'KubeadmArgsArgsDict']]] = None,
                 custom_delete: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 custom_update: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 triggers: Optional[pulumi.Input[Sequence[Any]]] = None,
                 __props__=None):
        """
        Create a Kubeadm resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a Kubeadm resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param KubeadmArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KubeadmArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KubeadmArgs.__new__(KubeadmArgs)
        ...
        super(Kubeadm, __self__).__init__(
            'baremetal:kubeadm:Kubeadm',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Kubeadm':
        """
        ...
        return Kubeadm(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def args(self) -> pulumi.Output['outputs.KubeadmArgs']:
        return pulumi.get(self, "args")
