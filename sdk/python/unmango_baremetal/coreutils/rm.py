...
class RmArgs:
    ...
    @property
    @pulumi.getter
    def args(self) -> pulumi.Input['RmArgsArgs']:
        return pulumi.get(self, "args")

    @args.setter
    def args(self, value: pulumi.Input['RmArgsArgs']):
...
class Rm(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 args: Optional[pulumi.Input[Union['RmArgsArgs', 'RmArgsArgsDict']]] = None,
                 custom_delete: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 custom_update: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 triggers: Optional[pulumi.Input[Sequence[Any]]] = None,
                 __props__=None):
